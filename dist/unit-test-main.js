...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"tsQ1":[function(require,module,exports) {
"use strict";
...
},{}],"WFPZ":[function(require,module,exports) {
"use strict";
...
},{}],"5yeb":[function(require,module,exports) {
"use strict";
...
function reactorHeaders(accessToken) {
  return {
    ...
    'User-Agent': `adobe-reactor-node/${_version.version}`
  };
}
},{"./version":"WFPZ"}],"sHbN":[function(require,module,exports) {
"use strict";
...
},{}],"xtdz":[function(require,module,exports) {
"use strict";
...
},{}],"7qYO":[function(require,module,exports) {
"use strict";
...
},{}],"j9L5":[function(require,module,exports) {
"use strict";
...
},{}],"eR+S":[function(require,module,exports) {
"use strict";
...
var _bodyIsJson = _interopRequireDefault(require("./body-is-json"));

var _reactorHeaders = _interopRequireDefault(require("./reactor-headers"));

var _createReviseBody = _interopRequireDefault(require("./create-revise-body"));

var adapters = _interopRequireWildcard(require("./adapters"));

var auditEvents = _interopRequireWildcard(require("./audit-events"));
...
var dataElements = _interopRequireWildcard(require("./data-elements"));

var environments = _interopRequireWildcard(require("./environments"));

var extensionPackages = _interopRequireWildcard(require("./extension-packages"));
...
var ruleComponents = _interopRequireWildcard(require("./rule-components"));
...
class Reactor {
  constructor(accessToken, options = {}) {
    ...
    const doLogging = options.loggingEnabled;
    if (typeof doLogging === 'undefined') doLogging = true;
    this.baseUrl = url.endsWith('/') ? url.slice(0, -1) : url;
    this.headers = (0, _reactorHeaders.default)(accessToken);
    this.createReviseBody = _createReviseBody.default;
    this.logging = options.doLogging;
    if (this.logging) console.info(`Using Reactor at ${this.baseUrl}`);
  }
  ...
  async requestAndLog(url, requestInfo, requestData) {
    ...
    const traceData = {
      ...
      // eg '404 not found'
      source: `${requestInfo.method} ${url.toString()}`,
      // eg 'GET http://x.io/'
    ...
    if (!response.ok) {
      if (this.logging) console.info('[Reactor SDK]', summary, traceData);
      throw new FetchError(traceData);
    }

    if (this.logging) console.debug('[Reactor SDK]', summary, traceData);
    return responseData;
  }
...
function extractErrorDetails(traceData) {
  ...
  const details = [traceData.response, ...errorList].map(x => x.detail).filter(x => typeof x !== 'undefined').map(x => `'${x}'`).join('; also, ');
...
},{"./body-is-json":"tsQ1","./reactor-headers":"5yeb","./create-revise-body":"sHbN","./adapters":"EAMl","./audit-events":"xtdz","./builds":"XCLB","./callbacks":"JGFn","./companies":"ZIHa","./data-elements":"7qYO","./environments":"uxiZ","./extension-packages":"j9L5","./extensions":"/vco","./heartbeat":"kfBa","./libraries":"1pU4","./profiles":"dcW0","./properties":"DrK5","./rule-components":"eR+S","./rules":"ZSE7"}],"lTk1":[function(require,module,exports) {
"use strict";

var _nock = _interopRequireDefault(require("nock"));

var _reactorHeaders = _interopRequireDefault(require("../../lib/reactor-headers"));
...
var reactor = new _reactor.default(accessToken, {
...
},{"../../lib/reactor-headers":"5yeb","../../lib/reactor":"QZzC"}],"ouSA":[function(require,module,exports) {
/*
Copyright 2019 Adobe. All rights reserved.
This file is licensed to you under the Apache License, Version 2.0 (the "License");
you may not use this file except in compliance with the License. You may obtain a copy
...
},{}],"5CsP":[function(require,module,exports) {
/*
Copyright 2019 Adobe. All rights reserved.
This file is licensed to you under the Apache License, Version 2.0 (the "License");
you may not use this file except in compliance with the License. You may obtain a copy
...
},{}],"qbNy":[function(require,module,exports) {
"use strict";

var _createReviseBody = _interopRequireDefault(require("../../lib/create-revise-body"));
...
},{"../../lib/create-revise-body":"sHbN"}],"vdQw":[function(require,module,exports) {
/*
Copyright 2019 Adobe. All rights reserved.
This file is licensed to you under the Apache License, Version 2.0 (the "License");
you may not use this file except in compliance with the License. You may obtain a copy
...
},{"../../lib/create-revise-body":"sHbN"}],"jLpW":[function(require,module,exports) {
/*
Copyright 2019 Adobe. All rights reserved.
This file is licensed to you under the Apache License, Version 2.0 (the "License");
you may not use this file except in compliance with the License. You may obtain a copy
...
},{"../../lib/create-revise-body":"sHbN"}],"PyZA":[function(require,module,exports) {
/*
Copyright 2019 Adobe. All rights reserved.
This file is licensed to you under the Apache License, Version 2.0 (the "License");
you may not use this file except in compliance with the License. You may obtain a copy
...
require("./data-element.test.js");

require("./environment.test.js");

require("./extension.test.js");

require("./extension-package.test.js");
...
require("./rule-component.test.js");

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }
},{"./../..":"QZzC","./helpers.js":"lTk1","./adapter.test.js":"ouSA","./audit-event.test.js":"5CsP","./build.test.js":"C+zT","./callback.test.js":"d2x8","./company.test.js":"yMxa","./data-element.test.js":"qbNy","./environment.test.js":"vdQw","./extension.test.js":"qF1X","./extension-package.test.js":"jLpW","./heartbeat.test.js":"l8Qs","./library.test.js":"nO0v","./profile.test.js":"DmBY","./property.test.js":"xjTb","./rule.test.js":"ekgI","./rule-component.test.js":"PyZA"}]},{},["epB2"], null)
